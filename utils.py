...
def search_params():
    SEARCHLIST = ['Live Strong','staged+shooting+NRA+gun+reform','Play Dough','Neutron','Vaccine','Transgenic','GMO','Genetically Modified Organism','neuromorphic hardware']
